...
Date: 02.06.2022
Description: Folder creation form
--}}
    ...
    <div class="relative inline-flex w-full mx-auto min-h-screen h-full sm:items-top py-4 sm:pt-0">
        <div class="my-auto mx-auto w-1/3">
            <form action="{{ route('folders.store') }}" method="POST">
                ...
                <button type="submit" class="font-semibold bg-PVred px-4 py-1 rounded-md border-PVred border-2 text-white hover:bg-red-500 active:bg-PVred focus:ring focus:ring-red-500 focus:ring-opacity-25 outline-none">Créer un dossier</button>
            </form>
        </div>
    </div>
@endsection
